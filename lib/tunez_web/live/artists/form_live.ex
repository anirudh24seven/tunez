defmodule TunezWeb.Artists.FormLive do
  ...
  def mount(%{"id" => artist_id}, _session, socket) do
    ...
    form = Tunez.Music.form_to_update_artist(artist, actor: socket.assigns.current_user)
  ...
  def mount(_params, _session, socket) do
    form = Tunez.Music.form_to_create_artist(actor: socket.assigns.current_user)
      |> AshPhoenix.Form.ensure_can_submit!()
